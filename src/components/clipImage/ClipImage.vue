<template>
	<div class="l-clip-image flex-box-column">
		<div class="l-clip-contant flex-1 flex-box-center" ref="clip-contant">
			<img
				ref="img"
				:src="url"
				v-if="url"
				...
				@load="onImgLoad"
			/>
			<canvas ref="canvas" class="clip-canvas"></canvas>
		</div>
		<div
			class="l-clip-tool flex-box flex-align-center flex-justify-space-between"
		>
			<span class="l-clip-tool-cancel" @click="cancel">取消</span>
			<span class="l-clip-tool-ok" @click="clipHandle">确定</span>
		</div>
	</div>
</template>
<script>
